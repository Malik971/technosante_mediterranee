...
const TAG_STYLES = {
  mer: {
    bg: "rgba(14,110,158,0.09)",
    color: "#0A5580",
    border: "rgba(14,110,158,0.18)",
  },
  garrigue: {
    bg: "rgba(139,116,202,0.09)",
    color: "#6B54AA",
    border: "rgba(139,116,202,0.18)",
  },
  terra: {
    bg: "rgba(201,92,53,0.09)",
    color: "#A54428",
    border: "rgba(201,92,53,0.18)",
  },
  soleil: {
    bg: "rgba(212,160,16,0.09)",
    color: "#A67808",
    border: "rgba(212,160,16,0.18)",
  },
  olive: {
    bg: "rgba(97,122,54,0.09)",
    color: "#455A24",
    border: "rgba(97,122,54,0.18)",
  },
};
