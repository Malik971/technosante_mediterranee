...
export default function Pagination({ page, totalPages, goTo, hasNext, hasPrev }) {
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          border:     hasPrev ? '1px solid rgba(201,92,53,0.20)' : '1px solid rgba(232,213,200,0.5)',
          color:      hasPrev ? '#C95C35' : '#D5C5AA',
          cursor:     hasPrev ? 'pointer' : 'not-allowed',
        }}
        onMouseEnter={(e) => { if (hasPrev) e.currentTarget.style.background = 'rgba(201,92,53,0.07)' }}
        onMouseLeave={(e) => { if (hasPrev) e.currentTarget.style.background = 'white' }}
      ...
      {pages.map((p, i) =>
        p === '…' ? (
          ...
          <button
            ...
            onMouseEnter={(e) => { if (p !== page) e.currentTarget.style.background = 'rgba(201,92,53,0.07)' }}
      ...
      <button
        ...
        style={{
          ...
          border:     hasNext ? '1px solid rgba(201,92,53,0.20)' : '1px solid rgba(232,213,200,0.5)',
          color:      hasNext ? '#C95C35' : '#D5C5AA',
          cursor:     hasNext ? 'pointer' : 'not-allowed',
        }}
        onMouseEnter={(e) => { if (hasNext) e.currentTarget.style.background = 'rgba(201,92,53,0.07)' }}
        onMouseLeave={(e) => { if (hasNext) e.currentTarget.style.background = 'white' }}
