...
export default function GrilleArticlesSection() {
  ...
  const [pages, setPages] = useState(
    Math.ceil(ARTICLES_STATIC.length / PER_PAGE),
  );
  ...
  const fetchArticles = useCallback(async () => {
    ...
    try {
      ...
      console.warn(
        "[GrilleArticles] API indisponible, affichage des données statiques :",
        err.message,
      );
      setApiError(true);
      setUsingStatic(true);
  ...
  return (
    ...
    >
      <div className="section-inner">
        ...
        >
          <div>
            <Tag variant="terra" className="mb-3">
              Tous les articles
            </Tag>
            <h2
              style={{
            ...
            >
              {loading ? (
                ...
                <>
                  {searchQuery ? displayed.length : total} article
                  {(searchQuery ? displayed.length : total) > 1 ? "s" : ""}
                  {activeFilter !== "all" && (
                    <span style={{ color: "#C95C35" }}> · filtrés</span>
                  )}
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div
              style={{ position: "relative", maxWidth: "280px", width: "100%" }}
            >
              <Search
                size={15}
                style={{
          ...
          <div style={{ textAlign: "center", padding: "60px 0" }}>
            <div
              style={{
                width: "28px",
                height: "28px",
                border: "3px solid rgba(201,92,53,0.2)",
                borderTopColor: "#C95C35",
                borderRadius: "50%",
                margin: "0 auto 14px",
        ...
        {!loading && displayed.length === 0 && (
          <div
            style={{
              ...
              padding: "80px 20px",
              borderRadius: "20px",
              border: "1px dashed rgba(201,92,53,0.20)",
              background:
                "linear-gradient(135deg,rgba(201,92,53,0.03),rgba(14,110,158,0.02))",
            }}
          >
            <div
              style={{
