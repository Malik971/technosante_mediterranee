...
export default function HeroActualites() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(150deg, #FEF4EF 0%, #FDFAF6 45%, #EFF7FB 100%)",
        paddingTop: "100px",
        paddingBottom: "0",
      }}
    ...
    >
      ...
      >
        <div
          ...
          style={{
            ...
            height: "460px",
            background:
              "radial-gradient(circle,rgba(201,92,53,0.13) 0%,transparent 70%)",
            top: "-130px",
            right: "-80px",
          }}
        />
        <div
          ...
          style={{
            ...
            height: "320px",
            background:
              "radial-gradient(circle,rgba(14,110,158,0.09) 0%,transparent 70%)",
            bottom: "-40px",
            left: "-40px",
            animationDelay: "4s",
          }}
      ...
      <div className="relative z-10 section-inner px-6 w-full py-16">
        ...
        <div className="flex flex-wrap items-end justify-between gap-6 mb-12">
          <div>
            ...
            <h1 className="animate-fade-up text-ardoise-800">
              ...
              <span
                style={{
                  background:
                    "linear-gradient(135deg,#C95C35 20%,#F0BC2A 60%,#C95C35 90%)",
          ...
          <p className="text-ardoise-500 text-base max-w-sm">
            Ségur, cybersécurité, logiciels, matériel — notre équipe décrypte
            l'actualité de l'informatique médicale pour vous.
          </p>
        </div>
            ...
            >
              <div
                style={{
                  ...
                  background:
                    featured.gradient ??
                    "linear-gradient(135deg,#FDE0D0,#FAC0A0)",
                  position: "relative",
                  overflow: "hidden",
                }}
              >
              ...
              <div style={{ background: "white", padding: "24px" }}>
                ...
                >
                  <Tag variant={CAT_VARIANT[featured.category] ?? "terra"}>
                    {featured.category}
                  </Tag>
                ...
                <span
                  style={{
                    ...
                    fontSize: "13px",
                    fontWeight: 700,
                    color: featured.accentColor ?? "#C95C35",
                  }}
                >
                  Lire l'article
                  <ArrowRight
              ...
              {recents.map((article) => (
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    {article.publishedAt && (
                      <p style={{ fontSize: "11px", color: "#B8905E" }}>
      ...
      <div className="overflow-hidden leading-none" aria-hidden="true">
        ...
        >
          <path
            d="M0,25 C360,50 720,0 1080,25 C1260,38 1380,28 1440,25 L1440,50 L0,50 Z"
            fill="#FDFAF6"
          />
        </svg>
      </div>
