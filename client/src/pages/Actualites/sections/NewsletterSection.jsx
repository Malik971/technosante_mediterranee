      ...
      <div className="section-inner">
        ...
        >
          ...
          <div
            ...
            style={{ background:'radial-gradient(circle,rgba(201,92,53,0.07) 0%,transparent 70%)', filter:'blur(20px)' }}
            aria-hidden="true"
          />
          <div
            className="absolute -bottom-8 -left-8 w-32 h-32 rounded-full pointer-events-none"
            style={{ background:'radial-gradient(circle,rgba(14,110,158,0.07) 0%,transparent 70%)', filter:'blur(16px)' }}
            aria-hidden="true"
          />
          ...
          <div className="relative z-10">
            ...
            <Tag variant="terra" className="mb-4">Newsletter</Tag>

            <h2
              className="text-ardoise-800 mb-4"
              style={{ fontSize:'clamp(1.4rem,2.5vw,1.9rem)', fontWeight:700 }}
            >
              L'actualité médicale<br />directement dans votre boîte.
            </h2>
            <p className="text-ardoise-500 text-base mb-8 max-w-md mx-auto leading-relaxed">
              Un email par mois — pas plus. Nos experts sélectionnent les actualités qui comptent vraiment pour votre cabinet.
            </p>
            ...
            {sent ? (
              ...
              <div
                ...
                style={{ background:'rgba(97,122,54,0.08)', border:'1px solid rgba(97,122,54,0.20)' }}
                role="status"
                aria-live="polite"
              >
                <CheckCircle size={28} style={{ color:'#617A36' }} aria-hidden="true" />
              ...
              >
                <div className="flex-1">
                  ...
                  />
                  {error && (
                    <p id="nl-error" className="text-xs text-terra-600 mt-1.5 text-left" role="alert">
                      {error}
                    </p>
                  )}
                </div>
