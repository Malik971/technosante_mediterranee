    ...
    >
      <div
        style={{
          ...
          flexShrink: 0,
          background:
            article.gradient ?? "linear-gradient(135deg,#FDE0D0,#FAC0A0)",
          display: "flex",
          alignItems: "center",
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <p
          style={{
            fontSize: "11px",
            fontWeight: 700,
            color: article.accentColor ?? "#C95C35",
            marginBottom: "3px",
          }}
        >
        ...
        {article.publishedAt && (
          <p style={{ fontSize: "11px", color: "#B8905E", marginTop: "3px" }}>
...
export default function ArticlePage() {
    ...
    fetch(`${API}/articles/${slug}`)
      ...
      .then((data) => {
        ...
        return fetch(`${API}/articles?category=${data.category}&limit=3`)
          ...
          .then((d) =>
            setRelated(
              (d.items ?? []).filter((a) => a.slug !== slug).slice(0, 3),
            ),
          );
      })
  ...
  return (
    <div
      style={{ background: "#FDFAF6", minHeight: "100vh", paddingTop: "80px" }}
    >
      {/* Skeleton chargement */}
      {loading && (
        <div
          style={{ maxWidth: "72rem", margin: "0 auto", padding: "40px 24px" }}
        >
          <div
            style={{
              height: "200px",
          ...
          >
            ...
            >
              ...
              <div style={{ maxWidth: "680px", paddingBottom: "48px" }}>
                <Tag
                  variant={CAT_VARIANT[article.category] ?? "terra"}
                  className="mb-5"
                >
                  {CAT_LABELS[article.category] ?? article.category}
                </Tag>
            ...
            >
              ...
              >
                <path
                  d="M0,20 C360,40 720,0 1080,20 C1260,30 1380,22 1440,20 L1440,40 L0,40 Z"
                  fill="#FDFAF6"
                />
              </svg>
            </div>
              ...
              <article>
                ...
                <p
                  style={{
                    ...
                    marginBottom: "40px",
                    paddingBottom: "40px",
                    borderBottom: "1px solid rgba(201,92,53,0.12)",
                  }}
                >
                  {article.excerpt}
                </p>
                ...
                {article.tags?.length > 0 && (
                  <div
                    style={{
                      ...
                      marginTop: "48px",
                      paddingTop: "32px",
                      borderTop: "1px solid rgba(232,213,200,0.7)",
                    }}
                  >
                    ...
                    {article.tags.map((t) => (
                      <Link
                        ...
                        style={{
                          ...
                          padding: "6px 12px",
                          borderRadius: "100px",
                          background: "rgba(201,92,53,0.08)",
                          color: "#A54428",
              ...
              >
                ...
                <div
                  style={{
                    ...
                    padding: "20px",
                    background:
                      "linear-gradient(135deg,rgba(201,92,53,0.07),rgba(240,188,42,0.05))",
                ...
                >
                  ...
                  >
                    Notre équipe répond par téléphone, sans engagement.
                  </p>
                  {AGENCES.map((a) => (
                    <a
                      key={a.id}
