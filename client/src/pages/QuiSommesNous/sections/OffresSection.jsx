...
const COLOR_STYLES = {
  terra: {
    ...
    tabActive: {
      ...
      color: "#fff",
      boxShadow: "0 4px 16px rgba(201,92,53,0.30)",
    },
    tabIdle: {
      background: "#fff",
      color: "#5A4428",
  ...
  mer: {
    ...
    tabActive: {
      ...
      color: "#fff",
      boxShadow: "0 4px 16px rgba(14,110,158,0.28)",
    },
    tabIdle: {
      background: "#fff",
      color: "#063D5E",
      border: "1px solid rgba(14,110,158,0.18)",
    },
  ...
  garrigue: {
    ...
    tabActive: {
      ...
      color: "#fff",
      boxShadow: "0 4px 16px rgba(139,116,202,0.28)",
    },
    tabIdle: {
      background: "#fff",
      color: "#3C2E70",
      border: "1px solid rgba(139,116,202,0.18)",
    },
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="flex items-start gap-5 mb-8">
        ...
        <div>
          <div className="flex items-center gap-3 mb-1">
            ...
            <Tag
              variant={offre.color === "garrigue" ? "garrigue" : offre.color}
            >
              {offre.title}
            </Tag>
          </div>
      ...
      <div
        ...
        style={{
          background: `linear-gradient(90deg, ${s.barColor}, transparent)`,
        }}
        aria-hidden="true"
      />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
        {offre.details.map((detail) => (
          ...
          >
            ...
            <p className="text-ardoise-500 text-sm leading-relaxed pl-8">
              {detail.desc}
            </p>
          </div>
        ))}
      ...
      <div className="section-inner">
        ...
        <div className="text-center mb-14">
          ...
          <p className="reveal text-ardoise-500 text-lg max-w-xl mx-auto">
            Aujourd'hui un simple soutien informatique ne suffit plus. Nous
            couvrons les 3 piliers de l'informatique médicale moderne.
          </p>
        </div>
        ...
        <div className="reveal grid lg:grid-cols-5 gap-8 items-start">
          ...
          <div className="lg:col-span-2 flex flex-col gap-3">
            ...
            >
              <p className="text-xs font-semibold text-ardoise-700 mb-1">
                Besoin d'un conseil ?
              </p>
              <p className="text-xs text-ardoise-500 mb-3">
                Notre équipe répond à toutes vos questions sans engagement.
              </p>
              <a
                href="tel:0499530532"
          ...
          {/* ── Panneau droite ── */}
          <div
            className="lg:col-span-3 bg-white rounded-xl3 p-5 sm:p-6 md:p-10"
            style={{
