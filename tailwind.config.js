  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'terra-gradient':
          'linear-gradient(135deg, #C95C35 0%, #A54428 100%)',
        'mer-gradient':
          'linear-gradient(135deg, #2088BF 0%, #0A5580 100%)',
        'soleil-gradient':
          'linear-gradient(135deg, #F0BC2A 0%, #D4A010 100%)',
      },
      ...
      boxShadow: {
        ...
        'card-hover':'0 8px 40px rgba(44,30,16,0.12), 0 2px 8px rgba(44,30,16,0.06)',
